...
## Lab section:
**For the POT April 19th to April 20th** we will be using the **ahsoka** clusters. 
...
[https://console-openshift-console.apps.ahsoka.coc-ibm.com/](https://console-openshift-console.apps.ahsoka.coc-ibm.com/)
